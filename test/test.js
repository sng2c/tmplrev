...
(function() {
  var ANY, BOF, EOF, PH, requirejs, tmplrev, underscore;
  ...
  exports.tmplrevTest = {
    'base test': function(test) {
      test.ok(!underscore.isEqual(BOF, EOF));
      test.ok(underscore.isEqual(ANY, ANY));
      test.ok(!underscore.isEqual(ANY, {
        name: "ANY"
      }));
      test.ok(!underscore.isEqual(ANY, "ANY"));
    ...
    'partition test': function(test) {
      test.notEqual(void 0, tmplrev.partition("abc", 1));
    ...
    'partitionBy test': function(test) {
      test.notEqual(void 0, tmplrev.partitionBy("abc", "b"));
    ...
    'full test': function(test) {
      var a, b, c, d, founds, i, labels, p, pats;
      a = ["[Web발신]", PH, PH, "승인", "김*승", "29,500", "원 ", PH, "02/25 16:12", "강동서울정형외", "누적", "919,360", "원"];
      b = ["[Web발신]", "KB국민카드", "2*2*", "승인", "김*승", "9,000", "원 ", "할부", "02/25 16:17", "봄약국", "누적", "928,360", "원"];
      c = ["[Web발신]", "KB국민카드", "2*2*", "승인", "김*승", "7,800", "원 ", "할부", "02/26 15:34", "강동서울정형외", "누적", "936,160", "원"];
      d = tmplrev.diff(a, b);
      // console.log [[d]]
    ...
    'object diff test': function(test) {
      var Token, a, b;
      Token = class Token {
